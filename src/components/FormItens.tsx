...
const FormItens: React.FC<FormItensProps> = ({
  ...
  const isSizeDisabled = item.category !== "Bebidas";
  const isSubCategoryDisabled = item.category !== "Bebidas";
  const isPromotionDisabled = !item.isPromotion;
          ...
          {item.isPromotion && (
            <div>
              ...
              <input
                ...
                className={
                  "w-full border-gray-300 rounded-md shadow-sm p-2 bg-gray-200"
                }
              />
            </div>
          )}
